...
qiime dada2 denoise-paired --i-demultiplexed-seqs paired-end-demux.qza --p-trunc-len-f 250 --p-trunc-len-r 180  --p-trim-left-f 0 --p-trim-left-r 0 --p-trunc-q 2 --o-table dada2-table.qza --o-representative-sequences dada2.rep-seqs.qza --o-denoising-stats denoise.statsqiime 
...
qiime diversity alpha-group-significance --i-alpha-diversity core-metrics-results/faith_pd_vector.qza --m-metadata-file metadata.txt --o-visualization core-metrics-results/faith_pd_vector.qzv
